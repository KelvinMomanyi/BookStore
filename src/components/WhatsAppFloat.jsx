export default function WhatsAppFloat() {
  const whatsappNumber = (import.meta.env.VITE_AUTHOR_WHATSAPP_NUMBER || "")
    .toString()
    .replace(/\D/g, "");
  const hasDirectNumber = Boolean(whatsappNumber);
  const whatsappHref = hasDirectNumber
    ? `https://wa.me/${whatsappNumber}`
    : "https://api.whatsapp.com/send?text=Hello%20Isaac%20Books%20International";
  ...
  return (
    <a
      ...
      title={
        hasDirectNumber
          ? "Chat with the author on WhatsApp"
          : "Set VITE_AUTHOR_WHATSAPP_NUMBER for direct author chat"
      }
    >
